...
export const PRODUCTS = [
  {
    ...
    strengths: ["50%", "60%", "75%"],
    description:
      "WHO-GMP certified Aspirin (Acetylsalicylic Acid) pellets manufactured in India for pharmaceutical formulations. These enteric-coated and sustained-release aspirin pellets offer uniform particle size, controlled moisture, and reliable dissolution profiles ideal for cardiovascular support, pain relief, and anti-inflammatory therapies. Trusted by global pharma companies for tablet compression and capsule filling.",
    grade: "IP / BP / USP / EP",
    unit: "25/50 kg",
    tags: ["pellet", "aspirin", "acetylsalicylic acid", "ASA", "enteric coated pellets", "sustained release", "cardiovascular pellets", "analgesic pellets", "anti-inflammatory", "pharmaceutical pellets manufacturer India", "WHO-GMP certified pellets"],
    image: "/assets/products/aspirin.jpg",
    seoTitle: "Aspirin Pellets Manufacturer India | WHO-GMP Certified ASA Pellets",
    seoDescription: "Premium Aspirin (Acetylsalicylic Acid) pellets from Rraynex - WHO-GMP certified manufacturer in India. Enteric-coated & sustained-release options for cardiovascular & pain relief formulations. IP/BP/USP/EP grades available.",
    relatedProducts: ["product-clopidogrel", "product-clopidogrel-aspirin", "product-omeprazole"],
  },
  {
    ...
    description:
      "High-purity Clopidogrel bisulfate pellets manufactured under WHO-GMP conditions for cardiovascular therapy. These antiplatelet pellets ensure consistent bioavailability, stable layering, and excellent flow properties for fixed-dose combination tablets and capsules. Ideal for DAPT regimens, post-PCI care, and stroke prevention formulations with complete regulatory documentation support.",
    grade: "IP / BP / USP / EP",
    unit: "25/50 kg",
    tags: ["pellet", "clopidogrel", "clopidogrel bisulfate", "antiplatelet pellets", "cardiovascular pellets", "DAPT therapy", "post-PCI pellets", "stroke prevention", "WHO-GMP certified pellets", "pharmaceutical pellets India", "fixed-dose combination pellets"],
    image: "/assets/products/clopidogrel.jpg",
    seoTitle: "Clopidogrel Pellets Manufacturer | Antiplatelet API Pellets India",
    seoDescription: "WHO-GMP compliant Clopidogrel bisulfate pellets for cardiovascular formulations. Consistent bioavailability, stable layering & regulatory-ready documentation. Leading antiplatelet pellets manufacturer in India.",
    relatedProducts: ["product-aspirin", "product-clopidogrel-aspirin", "product-atorvastatin"],
  },
  {
    ...
    description:
      "Dual antiplatelet combination pellets featuring Clopidogrel and Aspirin in optimized ratios for cardiovascular protection. Engineered for balanced particle size distribution, these FDC pellets streamline manufacturing of post-PCI maintenance tablets and high-risk cardiac patient regimens. WHO-GMP certified production with complete stability data and regulatory support.",
    grade: "IP / BP / USP / EP",
    unit: "25/50 kg",
    tags: ["pellet", "clopidogrel", "aspirin", "dual antiplatelet", "FDC pellets", "combination pellets", "cardiovascular pellets", "post-PCI therapy", "DAPT pellets", "fixed-dose combination", "pharmaceutical pellets India", "WHO-GMP certified"],
    image: "/assets/products/placeholder.jpg",
    seoTitle: "Clopidogrel + Aspirin Combination Pellets | Dual Antiplatelet FDC India",
    seoDescription: "Optimized Clopidogrel + Aspirin dual antiplatelet pellets for post-PCI & cardiovascular care. WHO-GMP certified FDC pellets manufacturer in India with balanced particle size & regulatory support.",
    relatedProducts: ["product-clopidogrel", "product-aspirin", "product-atorvastatin-plus-clopidogrel"],
  },
  {
    ...
    description:
      "WHO-GMP certified Duloxetine HCl enteric-coated pellets for SNRI therapy in depression, neuropathic pain, and generalized anxiety disorder formulations. These pharmaceutical-grade pellets feature controlled release profiles, excellent stability, and uniform coating for consistent bioavailability. Manufactured in India with complete regulatory documentation for global markets.",
    grade: "IP / BP / USP / EP",
    unit: "25/50 kg",
    tags: ["pellet", "duloxetine", "duloxetine HCl", "SNRI pellets", "antidepressant pellets", "neuropathic pain pellets", "anxiety disorder pellets", "enteric coated pellets", "pharmaceutical pellets India", "WHO-GMP certified", "mental health formulations"],
    image: "/assets/products/placeholder.jpg",
    seoTitle: "Duloxetine Pellets Manufacturer | SNRI Antidepressant Pellets India",
    seoDescription: "Premium Duloxetine HCl enteric-coated pellets for depression & neuropathic pain formulations. WHO-GMP certified SNRI pellets manufacturer in India with IP/BP/USP/EP grades.",
    relatedProducts: ["product-escitalopram", "product-venlafaxine", "product-pregabalin"],
  },
  {
    ...
    type: "Pellets",
    family: "pellets",
    category: "Anti-Ulcerant (PPIs)",
    strengths: ["15%", "17%", "20%", "22.5%"],
    description:
      "Advanced dual delayed-release Dexlansoprazole pellets for extended acid suppression in GERD and erosive esophagitis treatment. These R-enantiomer PPI pellets offer staged gastric release for once-daily dosing, superior acid control, and enhanced patient compliance. WHO-GMP manufactured with tight particle size distribution for consistent performance.",
    grade: "IP / BP / USP / EP",
    unit: "25/50 kg",
    tags: ["pellet", "dexlansoprazole", "PPI pellets", "GERD pellets", "dual delayed-release", "acid suppression pellets", "proton pump inhibitor", "erosive esophagitis", "pharmaceutical pellets India", "WHO-GMP certified", "gastroenterology formulations"],
    image: "/assets/products/placeholder.jpg",
    seoTitle: "Dexlansoprazole Pellets | Dual Delayed-Release PPI Manufacturer India",
    seoDescription: "Dexlansoprazole dual delayed-release pellets for GERD & erosive esophagitis. WHO-GMP certified PPI manufacturer in India with extended acid suppression technology.",
    relatedProducts: ["product-lansoprazole", "product-esomeprazole-ec", "product-omeprazole"],
  },
  {
    ...
    strengths: [],
    description:
      "Multiparticulate pellet system (MUPS) Dexlansoprazole for flexible formulation development in proton pump inhibitor programs. These multi-unit pellet systems enable customized tablet compression with excellent flow properties, uniform drug distribution, and controlled release characteristics. Ideal for advanced gastro-resistant formulations requiring precise dosing.",
    grade: "IP / BP / USP / EP",
    unit: "25/50 kg",
    tags: ["pellet", "dexlansoprazole", "MUPS pellets", "multiparticulate system", "PPI MUPS", "tablet compression pellets", "controlled release", "gastro-resistant", "pharmaceutical pellets India", "WHO-GMP certified", "advanced drug delivery"],
    image: "/assets/products/placeholder.jpg",
    seoTitle: "Dexlansoprazole MUPS Pellets | Multi-Unit Pellet System PPI India",
    seoDescription: "Dexlansoprazole MUPS (Multi-Unit Pellet System) for flexible PPI formulations. Advanced multiparticulate technology for tablet compression from WHO-GMP certified manufacturer.",
    relatedProducts: ["product-dexlansoprazole", "product-esomeprazole-mups", "product-omeprazole-mups"],
  },
  {
